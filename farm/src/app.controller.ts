...
import { BanIpGuard } from "./advanced-ban-ip.guard";
import { Response } from "express";

export const IsCuongName = () =>
  Matches(/^cuong$/, { message: "Name must be cuong" });
...
export class AppController {
  ...
  @UseGuards(JwtAuthGuard)
  @Get("cats")
  getCats(@User() user: { userId: number }): Promise<Cat[]> {
  ...
  @Get("csrf")
  provideCsrfToken(@Req() request: Request) {
